...
//Cambiar void a clase de Datos
    public void getDatosSerie() {
        ...
        var json = consumoApi.obtenerDatos("http://gutendex.com/books?search=pride%20and%20prejudice");
        //System.out.println(URL_BASE + BUSQUEDA_LIBRO + nombreLibro.replace(" ", "%20"));
